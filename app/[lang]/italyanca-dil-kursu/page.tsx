...
export async function generateMetadata({
  ...
  const meta = (dict as any)?.italyancaLandingPage?.meta || {
    title:
      lang === "en"
        ? "Italian Language Course | Akademik International"
        : lang === "ar"
          ? "دورة اللغة الإيطالية | Akademik International"
...
export default async function ItalyancaDilKursuPage({ params }: PageProps) {
  ...
  return (
    <main>
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                item: `https://www.avcilarakademik.com.tr/${lang}/italyanca-dil-kursu`,
              },
            ],
          }),
        }}
      ...
      {/* About (İtalyanca Eğitimi & Avantajları) */}
      ...
      {/* SEO Text (İtalyanca Neden Çalışmalı, 5 Neden vb.) */}
