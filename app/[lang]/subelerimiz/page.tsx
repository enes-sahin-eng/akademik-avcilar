...
export default async function SubelerPage({ params }: PageProps) {
  ...
  const localBusinessSchemas = campuses
    ...
    .map((c) => ({
      ...
      "@type": "LocalBusiness",
      "@id": `https://avcilaringilizcekursu.com.tr/${lang}${c.href}`,
      name: `Akademik International - ${c.label || c.name}`,
      telephone: c.phone,
      url: `https://avcilaringilizcekursu.com.tr/${lang}${c.href}`,
      image: `https://avcilaringilizcekursu.com.tr${c.image || "/brand/logo2.png"}`,
      address: {
        "@type": "PostalAddress",
        addressCountry: "TR",
