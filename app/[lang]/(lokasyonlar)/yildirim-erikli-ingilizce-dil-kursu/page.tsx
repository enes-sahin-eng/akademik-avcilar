...
const COURSE_KEY = "yildirimErikliIngilizceLandingPage";
const PAGE_SLUG = "yildirim-erikli-ingilizce-dil-kursu";
...
export default async function YildirimErikliIngilizceKursuPage({
  params,
}: PageProps) {
  const { lang: rawLang } = await params;
  if (!locales.includes(rawLang as Locale)) notFound();
