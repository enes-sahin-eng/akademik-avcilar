...
const COURSE_KEY = "bursaIngilizceLandingPage";
const PAGE_SLUG = "bursa-ingilizce-dil-kursu-fsm";
...
export default async function BursaIngilizceDilKursuFsmPage({
  params,
}: PageProps) {
  const { lang: rawLang } = await params;
  if (!locales.includes(rawLang as Locale)) notFound();
  ...
  return (
    <main>
      ...
      <UpcomingProgramsTable lang={lang} dictKey={COURSE_KEY} />
