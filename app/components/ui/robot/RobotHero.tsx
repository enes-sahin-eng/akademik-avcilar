...
export function RobotPrototype({
  neckParams = {
    baseR: 0.25, baseH: -0.01, midR: 0.23, midH: 0.02,
    lipBottomR: 0.27, lipBottomH: 0.025, lipTopR: 0.28, lipTopH: 0.05,
    innerR: 0.24, innerDropH: 0.03,
  },
  ...
  const isLovedRef = lovedRef ?? internalLovedRef;
  ...
  const fallState = useRef(0);
  const fallTime = useRef(0);
  const fallDirection = useRef(1);
  ...
  return (
    ...
    >
      ...
      <group ref={headRef} position={[0, design.alturaCabeza, 0]}>
        ...
        <RobotEar position={[-0.29, 0, 0]} isLeft={true} scale={design.tamanoOrejas} />
        <RobotEar position={[0.29, 0, 0]} isLeft={false} scale={design.tamanoOrejas} />
      </group>
    </group>
  );
}
      ...
      <div className={styles.navInner}>
        <div className={styles.navRow}>
          <div className={styles.navLeft}>
            {leftItems.map((item, idx) => (
              ...
              >
                ...
                {hoveredIndex === idx && (
                  <motion.div
                    layoutId="robot-hero-nav-indicator"
          ...
          <div className={styles.navRight}>
            ...
            <button onClick={onCtaClick} className={styles.ctaBtn} type="button">
              {ctaText}
  ...
  return (
    ...
    >
      <div className={styles.bgTextWrap}>
        <h1 className={styles.bgText}>{backgroundText}</h1>
      </div>
