...
interface PteCentersTableProps {
  lang: Locale;
}

export const PteCentersTable = async ({ lang }: PteCentersTableProps) => {
  const dictionary = await getDictionary(lang);
  const tableData = (dictionary as any)?.pteLandingPage?.centersTable;
