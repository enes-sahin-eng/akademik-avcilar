...
const languages = [
  { img: "/ispanya.webp", name: "İspanyolca Kursu" },
  { img: "/fransa.webp", name: "Fransızca Kursu" },
  { img: "/almanca.webp", name: "Almanca Dil Kursu" },
  { img: "/rusça.webp", name: "Rusça Dil Kursu" },
  { img: "/italyanca.webp", name: "İtalyanca Kursu" },
  { img: "/farsça.webp", name: "Farsça Kursu" },
  { img: "/çince.webp", name: "Çince Kursu" },
  { img: "/japan.webp", name: "Japonca Kursu" },
  { img: "/kore.webp", name: "Korece Kursu" },
  { img: "/osmanlıca.webp", name: "Osmanlıca Kursu" },
  { img: "/türkçe.webp", name: "Yabancılara Türkçe" },
  { img: "/türkçe.webp", name: "Türkçe Kursu" },
  { img: "/latince.webp", name: "Latince Kursu" },
  { img: "/portekiz.webp", name: "Portekizce Kursu" },
  { img: "/arapça.webp", name: "Arapça Dil Kursu" },
  { img: "/flemenkçe.webp", name: "Felemenkçe Dil Kursu" }
];
          ...
          <div>
            ...
            <div className={styles.newsletterForm}>
              <div className={styles.inputWrapper}>
                <input type="email" placeholder={footerData.emailPlaceholder} className={styles.emailInput} />
                <button className={styles.sendBtn}>{footerData.sendBtn}</button>
              </div>
