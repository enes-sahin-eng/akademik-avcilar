    ...
    <>
      ...
      <div className={styles.topBar}>
        ...
        <div className={styles.topBarRight}>
          <a
            href="https://www.instagram.com/brand/akademikinternational"
            target="_blank"
          ...
          <a
            href="https://tr-tr.facebook.com/brand/akademikbatidilleri/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://x.com/brand/akademikdilokul"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://tr.linkedin.com/company/brand/akademik-dil-kursu"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <nav className={`${styles.nav} ${isScrolled ? styles.navScrolled : ""}`}>
        <div className={styles.container}>
          ...
          <a href={`/${currentLocale}`} className={styles.logo}>
            <Image
              src="/brand/logo.png"
              alt="AKADEMİK INTERNATIONAL LANGUAGE SCHOOL" title="AKADEMİK INTERNATIONAL LANGUAGE SCHOOL"
              width={200}
              height={50}
