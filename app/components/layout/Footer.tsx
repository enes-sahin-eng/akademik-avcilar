        ...
        <div className={styles.bottomSection}>
          ...
          <div className={styles.partnersSection}>
            ...
            <div className={styles.logosRow}>
              <div className={styles.logoItem}>
                <Image src="/brand/british.webp" alt="British Council & IELTS" title="British Council & IELTS" height={60} width={250} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
              <div className={styles.logoItem}>
                <Image src="/brand/pearson.webp" alt="Pearson PTE" title="Pearson PTE" height={60} width={180} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
              <div className={styles.logoItem}>
                <Image src="/brand/language.webp" alt="LanguageCert" title="LanguageCert" height={60} width={220} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
            </div>
          </div>
          ...
          <div className={styles.groupSection}>
            ...
            <div className={styles.logosRow}>
              ...
              <div className={styles.logoItem}>
                <Image src="/brand/akademikAbroad.webp" alt="AKADEMİK ABROAD" title="AKADEMİK ABROAD" height={45} width={150} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
              <div className={styles.logoItem}>
                <Image src="/brand/akademikPublishing.webp" alt="The Academic Publishing" title="The Academic Publishing" height={45} width={120} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
              <div className={styles.logoItem}>
                <Image src="/brand/akademikKoleji.svg" alt="AKADEMİK Koleji International School" title="AKADEMİK Koleji International School" height={45} width={160} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
              <div className={styles.logoItem}>
                <Image src="/brand/akademikKids.svg" alt="AKADEMİK Kids" title="AKADEMİK Kids" height={45} width={160} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
              <div className={styles.logoItem}>
                <Image src="/brand/akademikAdult.webp" alt="AKADEMİK adult" title="AKADEMİK adult" height={45} width={150} style={{ height: 'auto' }} className={styles.logoImg} />
              </div>
            </div>
          </div>
          ...
          <div className={styles.devCredit}>
            <div className={styles.creditContainer}>
              ...
              <Image src="/brand/designer-logo.jpg" alt="ideaZone Logo" title="ideaZone Logo" width={40} height={18} style={{ height: 'auto' }} className={styles.designerLogo} />
            </div>
          </div>
        </div>
